    ...
    p3_animation(nullptr)
{
     ...
     //Set Background
     mw->set_background(":/resources/img/credits_AangStanding.jpg");
     ...
     QString creators = "Avatar: The Last Airbender\n\n\n"
                        "        CREATED BY  \n\n\n"
                        "      Dareen Atallah  \n\n"
                        "       Weiyu Huang   \n\n"
                        "        Peter Liu    \n\n"
...
void EndCredits::changeBackground(){
    delete paragraph1;
    paragraph1=nullptr;
    mw->set_background(":/resources/img/credits_Appa.jpg");
}
...
void EndCredits::changeBackground2(){
    ...
    mw->set_background(":/resources/img/credits_AangBentDown.jpg");
}
