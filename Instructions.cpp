...
Instructions::Instructions(MainWindow* w) : mw(w), skipButton(new QPushButton("Skip")), eff(nullptr), a(nullptr),
    paragraph(new QTextEdit()) {

    //set background
    mw->set_background(":/resources/img/instructions_AangAndOppa.jpg");
    ...
    QString instructions = "Instructions\n\n"
                           "1. Begin the game by clicking on the water nation \n"
